  ...
  return (
    <header data-tauri-drag-region className="app-header">
        ...
        <div className="window-controls">
          <button className="window-minimize-btn" onClick={handleMinimize} title="最小化">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M2 7H12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </button>
          <button className="window-maximize-btn" onClick={handleMaximize} title="最大化/元に戻す">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <rect x="2" y="2" width="10" height="10" stroke="currentColor" strokeWidth="2" />
            </svg>
          </button>
          <button className="window-close-btn" onClick={handleClose} title="閉じる">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
