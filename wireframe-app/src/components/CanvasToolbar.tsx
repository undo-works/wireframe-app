  ...
  return (
    <div className="canvas-toolbar">
      <div className="tool-group">
        ...
        <button
          className={tool === "rect" ? "tool active" : "tool"}
          onClick={() => onToolChange("rect")}
        >
          矩形
        </button>
        <button
          className={tool === "ellipse" ? "tool active" : "tool"}
      ...
      <label>
        ...
        <input
          ...
          min={1}
          onChange={(event) =>
            onCanvasChange({ ...canvas, width: Number(event.target.value) })
          }
        />
      </label>
      <label>
        ...
        <input
          ...
          min={1}
          onChange={(event) =>
            onCanvasChange({ ...canvas, height: Number(event.target.value) })
          }
        />
      </label>
      <label>
        ...
        <select
          ...
          onChange={(event) =>
            onCanvasChange({
              ...canvas,
              unit: event.target.value as CanvasUnit,
            })
          }
        >
      ...
      <label>
        ...
        <input
          ...
          onChange={(event) =>
            onCanvasChange({ ...canvas, background: event.target.value })
          }
        />
      </label>
