...
Tauriでは、アプリケーションが使用するAPIに対してパーミッションを設定する必要があります。
wireframe-app/src-tauri/capabilities/default.json に設定を追加します。
...
```json
{
  ...
  "permissions": [
    ...
    "core:window:allow-start-dragging" // <-- ここを追加
  ]
}
```
...
```json
{
  ...
  "permissions": [
    ...
    "core:window:allow-is-maximized", // <-- ここを追加
    "core:window:allow-maximize",    // <-- ここを追加
    "core:window:allow-unmaximize",   // <-- ここを追加
    "core:window:allow-is-minimized", // <-- ここを追加
    "core:window:allow-minimize",      // <-- ここを追加
    "core:window:allow-unminimize"    // <-- ここを追加
  ]
}
```
